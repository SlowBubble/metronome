...
(function(root) { 'use strict';
	...
	window.AudioContext && (function() {
		...
		midi.mediaStreamDst = null;
		midi.getMediaStreamDst = _ => {
			if (!midi.mediaStreamDst) {
				midi.mediaStreamDst = midi.getContext().createMediaStreamDestination();
			}
			return midi.mediaStreamDst;
		}
...
// 				console.log(MIDI.GM.byId[instrument].id, instrument, channelId);
			...
			source.connect(midi.getMediaStreamDst());
			source.gainNode.connect(midi.getMediaStreamDst());
			///
			if (useStreamingBuffer) {
				if (delay) {
					return setTimeout(function() {
